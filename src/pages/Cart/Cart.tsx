                  ...
                  <td>
                    <div className="flex justify-center items-center bg-slate-200 p-2 rounded-full">
                      <button
                        ...
                        className="w-12 h-12 mr-4 bg-red-500 text-white flex justify-center items-center"
                      ...
                      <button
                        ...
                        className="w-12 h-12 bg-[#597E52] text-white flex justify-center items-center"
                        style={{ borderRadius: "100%" }}
                      >
                        <FaPlus />
                      </button>
        ...
        <div className="bg-slate-100 p-8 border rounded">
          ...
          <div>
            <button
              ...
              className="btn bg-[#597E52] text-white font-bold text-xl w-full"
            >
              Proceed To Checkout
            </button>
          </div>
